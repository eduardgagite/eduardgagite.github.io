        ...
        <div className="mx-auto max-w-5xl px-3 h-16 grid grid-cols-[1fr_auto_1fr] items-center gap-2 relative sm:gap-4 sm:px-4">
          ...
          <Link to={homeTo} className="flex items-center gap-3 group max-[359px]:hidden" aria-label={t('nav.home')}>
            <div
              ...
              style={{
                background:
                  'linear-gradient(to bottom right, rgba(var(--theme-primary-rgb), 0.30), rgba(255, 255, 255, 0.10))',
              }}
            >
              {initials}
            </div>
            ...
            <div className="leading-tight hidden md:block">
              ...
              <span className="block text-[11px]" style={{ color: 'rgba(var(--theme-primary-rgb), 0.9)' }}>
                {t('hero.role')}
              </span>
            </div>
          </Link>
                ...
                <li key={activeBase || to}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        background:
                          'linear-gradient(to right, rgba(var(--theme-primary-rgb), 0.80), var(--theme-primary))',
