...
## Примечание о golang-standards/project-layout

В интернете часто встречается репозиторий **golang-standards/project-layout**. Важно понимать: это **неофициальный** проект, а не стандарт от команды Go. Разработчики Go (включая Расса Кокса) [публично отмечали](https://go.dev/doc/modules/layout), что это не официальный стандарт. Используйте его как источник вдохновения, но не как догму.

Официальные рекомендации по структуре проекта: [go.dev/doc/modules/layout](https://go.dev/doc/modules/layout).
