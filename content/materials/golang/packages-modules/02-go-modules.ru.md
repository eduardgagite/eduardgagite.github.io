...
- **Go Workspaces** — мультимодульная разработка без replace (раздел «Пакеты и модули → Go Workspaces»).
- **Пакеты и экспорт** — основы организации кода в пакеты (раздел «Пакеты и модули → Пакеты и экспорт»).
