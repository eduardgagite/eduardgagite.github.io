...
- **Транзакции и подготовленные выражения** — управление транзакциями и prepared statements (раздел «Базы данных → Транзакции и подготовленные выражения»).
- **Экосистема: sqlx, pgx, GORM** — популярные библиотеки поверх database/sql (раздел «Базы данных → Экосистема»).
- **Миграции и схема** — версионирование структуры БД (раздел «Базы данных → Миграции и схема»).
