...
- **Пакеты slices и sort** — готовые дженерик-функции для сортировки, поиска и трансформации срезов (раздел «Стандартная библиотека → sort и slices»).
- **Интерфейсы и встраивание** — когда вместо дженериков лучше использовать интерфейсы с методами (раздел «Структуры данных → Интерфейсы и встраивание»).
